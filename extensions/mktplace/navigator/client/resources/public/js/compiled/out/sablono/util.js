...
var m__6751__auto__ = (sablono.util.to_str[goog.typeOf(x__6750__auto__)]);
if(!((m__6751__auto__ == null))){
return m__6751__auto__.call(null,x);
} else {
var m__6751__auto____$1 = (sablono.util.to_str["_"]);
...
var x__6750__auto__ = (((x == null))?null:x);
var m__6751__auto__ = (sablono.util.to_uri[goog.typeOf(x__6750__auto__)]);
if(!((m__6751__auto__ == null))){
return m__6751__auto__.call(null,x);
} else {
var m__6751__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__6751__auto____$1 == null))){
return m__6751__auto____$1.call(null,x);
} else {
...
var len__7157__auto___26832 = arguments.length;
var i__7158__auto___26833 = (0);
while(true){
if((i__7158__auto___26833 < len__7157__auto___26832)){
args__7164__auto__.push((arguments[i__7158__auto___26833]));

var G__26834 = (i__7158__auto___26833 + (1));
i__7158__auto___26833 = G__26834;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__7165__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq26831){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26831));
});
/**
...
var vec__26836 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__26836,(0),null);
var words = cljs.core.nthnext.call(null,vec__26836,(1));
...
var G__26838 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__26838,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__26838;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__26839_SHARP_){
if(typeof p1__26839_SHARP_ === 'string'){
return p1__26839_SHARP_;
} else {
return cljs.core.seq.call(null,p1__26839_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__6087__auto__ = x__$1.hasDomain();
